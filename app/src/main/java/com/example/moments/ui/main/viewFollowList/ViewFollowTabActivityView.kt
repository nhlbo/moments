...
class ViewFollowTabActivityView : AppCompatActivity() {
    ...
    private fun initFollowLinear() {
        ...
        followersDataList.add(
            Followers(
                "https://firebasestorage.googleapis.com/v0/b/moments-167ed.appspot.com/o/ronaldo.jpeg?alt=media&token=aa233a9c-7315-431f-be37-8856986efdf7",
                "Carter Kris",
                true
            )
        )
        followersDataList.add(
            Followers(
                "https://firebasestorage.googleapis.com/v0/b/moments-167ed.appspot.com/o/download.png?alt=media&token=e0cb33be-ce04-41ef-8cf1-bfed0a4f1d2e",
                "Berenice Leffler",
                true
            )
        )
        followersDataList.add(
            Followers(
                "https://firebasestorage.googleapis.com/v0/b/moments-167ed.appspot.com/o/download%20(1).png?alt=media&token=ece35d69-9170-4cca-9c27-cc61c94c7a4d",
                "Arnold Corwin",
                false
            )
        )
        followersDataList.add(
            Followers(
                "https://firebasestorage.googleapis.com/v0/b/moments-167ed.appspot.com/o/download%20(2).png?alt=media&token=3e987ea7-61a1-4d35-bdf1-cb1de77ad401",
                "Mathias Metz",
                true
            )
        )
        followersDataList.add(
            Followers(
                "https://firebasestorage.googleapis.com/v0/b/moments-167ed.appspot.com/o/default_avatar.png?alt=media&token=0adf8096-f67f-4209-985c-7a5dff38a4d4",
                "Olin Ferry",
                false
            )
        )
        followersDataList.add(
            Followers(
                "https://firebasestorage.googleapis.com/v0/b/moments-167ed.appspot.com/o/168732.png?alt=media&token=9b63f702-91ed-402f-8778-d9ea009bfac1",
                "Eve Renner",
                false
            )
        )
        followersDataList.add(
            Followers(
                "https://firebasestorage.googleapis.com/v0/b/moments-167ed.appspot.com/o/168726.png?alt=media&token=1b124baf-36e5-44d2-98a7-20990f2e5a4d",
                "Miss Bonita Quitzon",
                true
            )
        )
