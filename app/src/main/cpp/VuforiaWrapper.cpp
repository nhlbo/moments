...
Java_com_example_moments_ui_vuforia_VuforiaActivityView_initAR(
    JNIEnv *env,
    jobject /* this */,
    jobject activity,
...
Java_com_example_moments_ui_vuforia_VuforiaActivityView_startAR(
        JNIEnv *env,
        jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_pauseAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.pauseAR();
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_resumeAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.resumeAR();
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_stopAR(
    JNIEnv *env,
    jobject /* this */)
{
    controller.stopAR();
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_deinitAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.deinitAR();
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_cameraPerformAutoFocus(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_cameraRestoreAutoFocus(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_initRendering(
        JNIEnv *env,
        jobject /* this */)
{
    // Define clear color
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_setTextures(
    JNIEnv *env,
    jobject /* this */,
...
JNIEXPORT void JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_deinitRendering(
    JNIEnv *env,
    jobject /* this */)
{
...
JNIEXPORT jboolean JNICALL
Java_com_example_moments_ui_vuforia_VuforiaActivityView_configureRendering(
        JNIEnv *env,
        jobject /* this */,
...
Java_com_example_moments_ui_vuforia_VuforiaActivityView_renderFrame(
        JNIEnv *env,
        jobject /* this */)
{
    ...
    if (controller.prepareToRender(viewport, nullptr, &vbTextureUnit))
    {
        ...
        std::string res = controller.getImageTargetResult(trackableProjection, trackableModelView, trackableModelViewScaled);
        if (!res.empty())
        {
