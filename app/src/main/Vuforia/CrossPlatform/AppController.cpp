...
namespace
{
    constexpr char licenseKey[] = "";

    constexpr float NEAR_PLANE = 0.01f;
    constexpr float FAR_PLANE = 5.f;
    Vuforia::TargetFinder* finder;

    const char* const kAccessKey = "19042f2dde58ae257e89dc5bf277877c1e00aaf9";
    const char* const kSecretKey = "aa9a58736e5ff88690443520eb15f09cc7df99d0";
}
    ...
    for (const Vuforia::TargetSearchResult* result: queryResults.results) {
        {
            ...
            //}
            return (std::string) cloudRecoResult->getUniqueTargetId();
        }
    }
